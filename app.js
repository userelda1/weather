  ...
  fetchData(url.currentWeather(lat, lon), function (currentWeather) {
    ...
    card.innerHTML = `
      ...
      <div class="weapper">
        ...
        <img src="./assests/images/weather_icons/${icon}.png" width="64" height="64" alt="${description}"
          class="weather-icon">
      </div>
      ...
      for (const [index, data] of forecastList.entries()) {
        ...
        tempLi.innerHTML = `
          <div class="card card-sm slider-card">
            ...
            <img src="./assests/images/weather_icons/${icon}.png" width="48" height="48" loading="lazy" alt="${description}"
        ...
        <div class="card card-sm slider-card">
          ...
          <img src="./assests/images/weather_icons/direction.png" width="48" height="48" loading="lazy" alt="direction"
      ...
      for (let i = 7, len = forecastList.length; i < len; i += 8) {
        ...
        li.innerHTML = `
          <div class="icon-wrapper">
            <img src="./assests/images/weather_icons/${icon}.png" width="36" height="36" alt="${description}"
              class="weather-icon" title="${description}">
